...
(virtual-chunks-esip-slides)=
````{grid-item-card}
:header: Virtual Chunks at Earthmover: From theory to production
:footer: ESIP Cloud Computing Cluster, May 2026

:::{iframe} /slides/virtual-chunks-esip/
:::

[View full screen](/slides/virtual-chunks-esip/) · [Download PDF](/slides/virtual-chunks-esip/virtual-chunks-esip.pdf)
````

(shortcutting-cloud-migrations-slides)=
````{grid-item-card}
...
(open-science-cloud-native-slides)=
````{grid-item-card}
...
(virtualizarr-icechunk-scipy-2025-slides)=
````{grid-item-card}
...
(virtualizarr-icechunk-datacube-slides)=
````{grid-item-card}
...
(virtualizarr-met-office-slides)=
````{grid-item-card}
...
(cubed-xarray-scipy-2023-slides)=
````{grid-item-card}
...
(largest-ocean-simulation-slides)=
````{grid-item-card}
